...
import { MARKETPLACE_CTA } from "../data/marketplaceData";
...
const MarketplaceCTA = () => {
  ...
  const ctaPrimaryText: string | undefined =
    "ctaPrimary" in MARKETPLACE_CTA &&
    typeof MARKETPLACE_CTA.ctaPrimary === "string"
      ? MARKETPLACE_CTA.ctaPrimary
      : undefined;
      ...
      <div className={PULSING_CONTENT_WRAPPER_CLASS}>
        <div className={PULSING_HEADER_CLASS}>
          <h2 className={PULSING_HEADING_CLASS}>
            {(() => {
              const full = MARKETPLACE_CTA.heading || "";
              const word = MARKETPLACE_CTA.highlightedWord;
          ...
          <p className={PULSING_SUBTITLE_CLASS}>
            {MARKETPLACE_CTA.subtitle}
          </p>
        </div>
        <div className={PULSING_CTA_WRAP_CLASS}>
          <CTAButtons
            primaryText={ctaPrimaryText}
            secondaryText={MARKETPLACE_CTA.ctaSecondary}
          />
        </div>
      </div>
    </section>
